...
SEXP R_dgraph_getkcore(SEXP graph, SEXP pmode, SEXP pk) {
  igraph_t c_graph;
  igraph_integer_t mode=(igraph_integer_t) REAL(pmode)[0];
  igraph_integer_t k=(igraph_integer_t) REAL(pk)[0];
  igraph_vector_t res;
  ...
  R_SEXP_to_igraph(graph, &c_graph);
  igraph_vector_init(&res, 0);
  dgraph_getkcore(&c_graph, &res, (igraph_neimode_t) mode, k);
...
SEXP R_dgraph_wtcoreness1(SEXP graph, SEXP pmode, SEXP pweights, SEXP ptype, SEXP palpha, SEXP pbeta, SEXP plambda) {
  
  igraph_t g;
  igraph_integer_t mode=(igraph_integer_t) REAL(pmode)[0];
  igraph_integer_t type=(igraph_integer_t) REAL(ptype)[0];
  igraph_vector_t weights;
  igraph_integer_t alpha=(igraph_integer_t) REAL(palpha)[0];
  igraph_integer_t beta=(igraph_integer_t) REAL(pbeta)[0];
  igraph_real_t lambda=(igraph_real_t) REAL(plambda)[0];
  igraph_vector_t res;
  SEXP result;
  ...
  R_SEXP_to_igraph(graph, &g);
  igraph_vector_init(&res, 0);
  dgraph_wtcoreness1(&g, &res, (igraph_neimode_t) mode, &weights, type, alpha, beta, lambda);
...
SEXP R_dgraph_wtcoreness2(SEXP graph, SEXP pmode, SEXP pweights, SEXP ptype, SEXP palpha, SEXP pbeta, SEXP plambda) {
  ...
  R_SEXP_to_igraph(graph, &g);
  igraph_vector_init(&res, 0);
  dgraph_wtcoreness2(&g, &res, (igraph_neimode_t) mode, &weights, type, alpha, beta, lambda);
...
SEXP R_dgraph_getwtkcore(SEXP graph, SEXP pmode, SEXP pk, SEXP pweights, SEXP ptype, SEXP palpha, SEXP pbeta, SEXP plambda, SEXP pwtdeg) {
  ...
  igraph_integer_t beta=(igraph_integer_t) REAL(pbeta)[0];
  igraph_real_t lambda=(igraph_real_t) REAL(plambda)[0];
  igraph_integer_t wtdeg=(igraph_integer_t) REAL(pwtdeg)[0];
  igraph_vector_t res;
 // SEXP res;
  ...
  R_SEXP_to_igraph(graph, &c_graph);
  igraph_vector_init(&res, 0);
  dgraph_getwtkcore(&c_graph, &res, (igraph_neimode_t) mode, k, &weights, type, alpha, beta, lambda, wtdeg);
...
SEXP R_dgraph_trussness(SEXP graph) {
